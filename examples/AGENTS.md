...
Scope: the APIFlask example apps. For repo-wide commands see the root [AGENTS.md](../AGENTS.md).
...
- A new example must:
  ...
  - Usually be referenced from a section of `docs/` (see [docs AGENTS.md](../docs/AGENTS.md)).
