...
@pytest.mark.skipif(flask_sqlalchemy.__version__ < '3', reason="Need flask_sqlalchemy 3 for get_or_404")
@pytest.mark.parametrize('client', examples, indirect=True)
...
@pytest.mark.skipif(flask_sqlalchemy.__version__ < '3', reason="Need flask_sqlalchemy 3 for paginate")
